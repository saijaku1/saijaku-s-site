const notices = [
  {
    ...
    category: "ニュース",
    content:
      "どうも。最近テスト勉強が忙しすぎて開発もしきれていないじゃくです。ここからはテスト期間と受験期間なので、しばらく開発を中止します。再開は2026年2月18日の予定をしています。ご迷惑をかけて申し訳ありませんが、ご理解ご協力をお願いします",
  },
     {
    title: "活動再開！！",
    date: "2026-03-05",
    category: "ニュース",
    content:
      "受験が終わって無事、高校に合格したので活動再開します！！",
  },
   {
    title: "自己紹介を別のページに移し替えました",
    date: "2026-03-06",
    category: "変更点",
    content:
      "キャラクターが増えすぎたので、別のページに移し替えました！ちなみに見やすいよ！！あと今茶番頑張って作っているから楽しみにしててね！",
  },
];
